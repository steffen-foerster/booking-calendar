<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calendar.aspx.cs" Inherits="aspx_calendar_calendar" %>
  ...
  <form id="calendar" runat="server">
    <div style="border:1px solid <%# borderColor %>;padding-top:10px;padding-bottom:5px;background-color:#FFFFFF">
      ...
      <table style="border:0;margin:0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td style="vertical-align:top;">
            <booking:OccupancyCalendar  year="<%# ((DateTime)dates[12]).Year %>" month="<%# ((DateTime)dates[12]).Month %>" 
                                        houseId="<%# houseId %>" imagePath="../../images" runat="server"/>
          </td>
          <td style="vertical-align:top;">
            <booking:OccupancyCalendar  year="<%# ((DateTime)dates[13]).Year %>" month="<%# ((DateTime)dates[13]).Month %>" 
                                        houseId="<%# houseId %>" imagePath="../../images" runat="server"/>
          </td>
          <td style="vertical-align:top;">
            <booking:OccupancyCalendar  year="<%# ((DateTime)dates[14]).Year %>" month="<%# ((DateTime)dates[14]).Month %>" 
                                        houseId="<%# houseId %>" imagePath="../../images" runat="server"/>
          </td>
          <td style="vertical-align:top;">
            <booking:OccupancyCalendar  year="<%# ((DateTime)dates[15]).Year %>" month="<%# ((DateTime)dates[15]).Month %>" 
                                        houseId="<%# houseId %>" imagePath="../../images" runat="server"/>
          </td>
        </tr>
      </table>
